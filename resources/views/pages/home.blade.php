...
<div class="col-sm-3 col-lg-3 m-2 shadow ">
    <img src="{{URL('images/shirt.jpg')}}" class="img-fluid" style="padding-bottom:70px">
...
<div class="col-sm-3 col-lg-4 m-2 shadow m-2">
    <img src="{{URL('images/glass.jpg')}}" class="img-fluid" style="padding-bottom:125px">
    
    <p class="text-center">Glasses</p>
    <p class="text-center text-primary">K300</p>
</div>
<div class="col-sm-3 col-lg-3 m-2 shadow m-2">
    <img src="{{URL('images/watch.jpg')}}" class="img-fluid" style="padding-bottom:195px">
